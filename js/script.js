...
function populateExperienceSection(experience) {
  ...
  document.getElementById("iexp-project1-title").textContent =
    experience.project1.title;
  document.getElementById("iexp-project1-text").textContent =
    experience.project1.text;
  document.getElementById("iexp-project2-title").textContent =
    experience.project2.title;
  document.getElementById("iexp-project2-text").textContent =
    experience.project2.text;
}
